...
def infer_img(metric_net, bbox_json, bbox_scale='SM', key='feat'):
...
def get_pred_img(metric_net, bbox_json, save_path, key):
    ...
    inst_ds = infer_img(metric_net, bbox_json, bbox_scale='SM', key=key)
